...
void init_screens(void)
{
    ...
    C2D_TextParse(&text[TEXT_SPLASH_MODE], staticBuf, "開机動画模式");
    ...
    C2D_TextParse(&text[TEXT_THEMEPLAZA_THEME_MODE], staticBuf, "主題广場 主題模式");
    C2D_TextParse(&text[TEXT_THEMEPLAZA_SPLASH_MODE], staticBuf, "主題广場 開机動画模式");
    ...
    C2D_TextParse(&text[TEXT_ERROR_CONTINUE], staticBuf, "按 \uE000 継續");
    ...
    C2D_TextParse(&text[TEXT_INSTALL_LOADING_SPLASHES], staticBuf, "正在讀取開机動画中，請稍等...");
    C2D_TextParse(&text[TEXT_INSTALL_LOADING_ICONS], staticBuf, "正在讀取圖標中，請稍等...");

    C2D_TextParse(&text[TEXT_INSTALL_SPLASH], staticBuf, "正在安装開机動画中...");
    C2D_TextParse(&text[TEXT_INSTALL_SPLASH_DELETE], staticBuf, "正在刪除開机動画中...");

    C2D_TextParse(&text[TEXT_INSTALL_SINGLE], staticBuf, "正在安装主題中...");
    C2D_TextParse(&text[TEXT_INSTALL_SHUFFLE], staticBuf, "正在安装隨机主題組中...");
    C2D_TextParse(&text[TEXT_INSTALL_BGM], staticBuf, "正在安装主題的BGM中...");
    C2D_TextParse(&text[TEXT_INSTALL_NO_BGM], staticBuf, "正在安装主題圖片中...");

    C2D_TextParse(&text[TEXT_INSTALL_DOWNLOAD], staticBuf, "正在下載中...");
    C2D_TextParse(&text[TEXT_INSTALL_CHECKING_DOWNLOAD], staticBuf, "正在檢査下載的文件...");
    C2D_TextParse(&text[TEXT_INSTALL_ENTRY_DELETE], staticBuf, "正在从SD記憶体中刪除中...");

    C2D_TextParse(&text[TEXT_INSTALL_LOADING_REMOTE_THEMES], staticBuf, "正在下載主題列表中，請稍等...");
    C2D_TextParse(&text[TEXT_INSTALL_LOADING_REMOTE_SPLASHES], staticBuf, "正在下載開机列表中，請稍等...");
